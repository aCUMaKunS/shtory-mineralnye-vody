...
- `styles.css` — стили
- `script.js` — бургер-меню, плавный скролл, текущий год в подвале
- `images/` — SVG-заглушки фото и логотипа

## Что заменить перед публикацией

Памятка также продублирована HTML-комментарием в начале `index.html`.

1. **Телефон** — заменить везде `+7 (000) 000-00-00` и `tel:+70000000000` на реальный номер.
2. **WhatsApp** — заменить ссылки `https://wa.me/70000000000` на `https://wa.me/<ваш номер без +>`.
3. **Telegram** — заменить ссылки `https://t.me/username` на ваш юзернейм.
4. **Фото** — в папке `images/` сейчас SVG-заглушки (`hero-bg.svg`, `curtain-*.svg`, `avatar*.svg`). Замените на реальные фотографии штор и логотип, обновив пути в `index.html`.

Быстрый поиск всех мест: ищите в `index.html` строки `70000000000`, `username`, `images/`.
