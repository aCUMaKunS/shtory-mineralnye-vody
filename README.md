...
4. **Фото фона hero** — `images/hero-bg.svg` пока SVG-заглушка, замените на фото интерьера. Фото штор в карточках (`images/классические.jpg`, `римские.jpg`, `рулон.webp`, `блэкаут.jpg`, `тюль.jpg`) уже реальные.
